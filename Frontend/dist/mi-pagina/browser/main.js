...
var routes = [
  ...
  {
    path: "dashboard",
    loadComponent: () => import("./chunk-TYOHIFIO.js").then((m) => m.DashboardComponent)
  },
  {
    path: "quests",
    loadComponent: () => import("./chunk-P2ATGDS5.js").then((m) => m.QuestsPageComponent)
  },
  {
    path: "skills",
    loadComponent: () => import("./chunk-4UEBME6O.js").then((m) => m.SkillsPageComponent)
  },
  {
    path: "character",
    loadComponent: () => import("./chunk-ZJSD7UGX.js").then((m) => m.CharacterPageComponent)
  },
  {
    path: "settings",
    loadComponent: () => import("./chunk-AI3BC4KC.js").then((m) => m.SettingsComponent)
  },
  {
    path: "calendar",
    loadComponent: () => import("./chunk-UHI3M3RP.js").then((m) => m.CalendarComponent)
  },
...
function SidebarComponent_li_7_span_4_Template(rf, ctx) {
  if (rf & 1) {
...
function SidebarComponent_li_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li")(1, "a", 10)(2, "span", 11);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, SidebarComponent_li_7_span_4_Template, 2, 1, "span", 12);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
var SidebarComponent = class _SidebarComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 9, vars: 6, consts: [[1, "sidebar"], [1, "sidebar-logo", 3, "click"], [1, "logo-icon", "pixel"], ["class", "logo-text", 4, "ngIf"], ["class", "streak-badge", 4, "ngIf"], [1, "nav-list"], [4, "ngFor", "ngForOf"], ["class", "sidebar-footer", 4, "ngIf"], [1, "logo-text"], [1, "streak-badge"], ["routerLinkActive", "active", 1, "nav-item", 3, "routerLink", "title"], [1, "nav-icon"], ["class", "nav-label", 4, "ngIf"], [1, "nav-label"], [1, "sidebar-footer"], [1, "stars-deco"]], template: function SidebarComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(3, "\u2660");
        \u0275\u0275elementEnd();
        \u0275\u0275template(4, SidebarComponent_span_4_Template, 2, 0, "span", 3);
        \u0275\u0275elementEnd();
        \u0275\u0275template(5, SidebarComponent_div_5_Template, 5, 1, "div", 4);
        \u0275\u0275elementStart(6, "ul", 5);
        \u0275\u0275template(7, SidebarComponent_li_7_Template, 5, 4, "li", 6);
        \u0275\u0275elementEnd();
        \u0275\u0275template(8, SidebarComponent_div_8_Template, 2, 0, "div", 7);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
